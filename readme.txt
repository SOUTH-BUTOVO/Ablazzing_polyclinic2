Дз Поликлиника
Цель дз: имитация работы поликлиники используя Spring boot.
В поликлинике есть врачи и касса. Люди приходят в поликлинику, лечатся у определенных специалистов,
...
3. Создать класс врач, атрибуты: стоимость приема, специализация. Умеет лечить человека (логирует "{Специализация врача}
вылечил человека", возвращает стоимость приема.
...
4. Создать класс поликлиника: хранит в себе кассу, а так же специалистов:
 ...
 -младшего хирурга
 -старшего хирурга.
Старший и младший хирурги отличаются лишь стоимостью приема (т.е. они оба врачи со специализацией хирург,
просто ставки отличаются).
